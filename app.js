...
const INITIAL_PRODUCTS = [
  ...
  "image": "Image/Apple iPad Air 11″ (M2) Liquid Retina Display, 256GB, Landscape 12MP Front Camera  12MP Back Camera, Wi-Fi 6E, Touch ID, All-Day Battery Life-Gray/22_87148f00-12f9-4e5e-9951-8717bdcb21de_679x679.webp",
  "images": [
...
async function getProducts() {
    ...
    if (db) {
        try {
            ...
            if (ipadIndex !== -1) {
                ...
                if (!ipad.description || (typeof ipad.image === 'string' && ipad.image.includes('look-10287.myshopify.com'))) {
    ...
    if (ipadIndexLocal !== -1) {
        ...
        if (!ipadLocal.description || (typeof ipadLocal.image === 'string' && ipadLocal.image.includes('look-10287.myshopify.com'))) {

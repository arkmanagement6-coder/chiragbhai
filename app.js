...
async function getProducts() {
    ...
    if (db) {
        try {
            ...
            // Auto-update iPad product 8270415000000 if it's the old version in Firestore
    ...
    // Auto-update iPad product 8270415000000 in local storage if it's the old version

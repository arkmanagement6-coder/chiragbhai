        ...
        req.on('end', () => {
            try {
                ...
                if (data.gateway === 'sabpaisa') {
                    ...
                    console.log(`[SabPaisa Request] Host: ${hostname}, MID: ${merchantId}, TxnId: ${merchantTxnId}, Amount: ${amountInPaise} paise`);
                    ...
                    const apiReq = https.request(options, (apiRes) => {
                        ...
                        apiRes.on('end', () => {
                            console.log(`[SabPaisa Response] Code: ${apiRes.statusCode}`);
